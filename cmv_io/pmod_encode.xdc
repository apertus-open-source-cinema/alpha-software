...
set_property PACKAGE_PIN Y11 [get_ports {pmod_jad[0]}]
set_property PACKAGE_PIN AB11 [get_ports {pmod_jad[1]}]
set_property PACKAGE_PIN AA11 [get_ports {pmod_jad[2]}]
set_property PACKAGE_PIN AB10 [get_ports {pmod_jad[3]}]

set_property PACKAGE_PIN Y10 [get_ports {pmod_jac[0]}]
set_property PACKAGE_PIN AB9 [get_ports {pmod_jac[1]}]
set_property PACKAGE_PIN AA9 [get_ports {pmod_jac[2]}]
set_property PACKAGE_PIN AA8 [get_ports {pmod_jac[3]}]
