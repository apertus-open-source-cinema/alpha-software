...
dc1394error_t
dc1394_bayer_NearestNeighbor(const uint8_t *__restrict__ bayer, uint8_t *__restrict__ rgb, int sx, int sy, int tile)
{
...
dc1394error_t
dc1394_bayer_Bilinear(const uint8_t *__restrict__ bayer, uint8_t *__restrict__ rgb, int sx, int sy, int tile)
{
    const int bayerStep = sx;
    const int rgbStep = 3 * sx;
    int width = sx;
...
dc1394error_t
dc1394_bayer_HQLinear(const uint8_t *__restrict__ bayer, uint8_t *__restrict__ rgb, int sx, int sy, int tile)
{
    const int bayerStep = sx;
    const int rgbStep = 3 * sx;
    int width = sx;
...
dc1394error_t
dc1394_bayer_EdgeSense(const uint8_t *__restrict__ bayer, uint8_t *__restrict__ rgb, int sx, int sy, int tile)
{
...
/* coriander's Bayer decoding */
dc1394error_t
dc1394_bayer_Downsample(const uint8_t *__restrict__ bayer, uint8_t *__restrict__ rgb, int sx, int sy, int tile)
{
...
dc1394error_t
dc1394_bayer_Simple(const uint8_t *__restrict__ bayer, uint8_t *__restrict__ rgb, int sx, int sy, int tile)
{
    const int bayerStep = sx;
    const int rgbStep = 3 * sx;
    int width = sx;
...
/* insprired by OpenCV's Bayer decoding */
dc1394error_t
dc1394_bayer_NearestNeighbor_uint16(const uint16_t *__restrict__ bayer, uint16_t *__restrict__ rgb, int sx, int sy, int tile, int bits)
{
    const int bayerStep = sx;
    const int rgbStep = 3 * sx;
    int width = sx;
...
/* OpenCV's Bayer decoding */
dc1394error_t
dc1394_bayer_Bilinear_uint16(const uint16_t *__restrict__ bayer, uint16_t *__restrict__ rgb, int sx, int sy, int tile, int bits)
{
    const int bayerStep = sx;
    const int rgbStep = 3 * sx;
    int width = sx;
...
/* High-Quality Linear Interpolation For Demosaicing Of
   ...
   Ross Cutler, in ICASSP'04 */
dc1394error_t
dc1394_bayer_HQLinear_uint16(const uint16_t *__restrict__ bayer, uint16_t *__restrict__ rgb, int sx, int sy, int tile, int bits)
{
    const int bayerStep = sx;
    const int rgbStep = 3 * sx;
    int width = sx;
...
/* coriander's Bayer decoding */
dc1394error_t
dc1394_bayer_EdgeSense_uint16(const uint16_t *__restrict__ bayer, uint16_t *__restrict__ rgb, int sx, int sy, int tile, int bits)
{
    /* Removed due to patent concerns */
    return DC1394_FUNCTION_NOT_SUPPORTED;
}
...
/* coriander's Bayer decoding */
dc1394error_t
dc1394_bayer_Downsample_uint16(const uint16_t *__restrict__ bayer, uint16_t *__restrict__ rgb, int sx, int sy, int tile, int bits)
{
...
/* coriander's Bayer decoding */
dc1394error_t
dc1394_bayer_Simple_uint16(const uint16_t *__restrict__ bayer, uint16_t *__restrict__ rgb, int sx, int sy, int tile, int bits)
{
    uint16_t *outR, *outG, *outB;
    register int i, j;
    int tmp, base;
...
dc1394error_t
dc1394_bayer_VNG(const uint8_t *__restrict__ bayer,
                 uint8_t *__restrict__ dst, int sx, int sy,
...
dc1394error_t
dc1394_bayer_VNG_uint16(const uint16_t *__restrict__ bayer,
                        uint16_t *__restrict__ dst, int sx, int sy,
...
dc1394error_t
dc1394_bayer_AHD(const uint8_t *__restrict__ bayer,
                 uint8_t *__restrict__ dst, int sx, int sy,
                 dc1394color_filter_t pattern)
{
...
dc1394error_t
dc1394_bayer_AHD_uint16(const uint16_t *__restrict__ bayer,
                        uint16_t *__restrict__ dst, int sx, int sy,
                        dc1394color_filter_t pattern, int bits)
{
    int i, j, top, left, row, col, tr, tc, fc, c, d, val, hm[2];
...
dc1394error_t
dc1394_bayer_decoding_8bit(const uint8_t *__restrict__ bayer, uint8_t *__restrict__ rgb, uint32_t sx, uint32_t sy, dc1394color_filter_t tile, dc1394bayer_method_t method)
{
    switch (method) {
...
dc1394error_t
dc1394_bayer_decoding_16bit(const uint16_t *__restrict__ bayer, uint16_t *__restrict__ rgb, uint32_t sx, uint32_t sy, dc1394color_filter_t tile, dc1394bayer_method_t method, uint32_t bits)
{
    switch (method) {
    case DC1394_BAYER_METHOD_NEAREST:
