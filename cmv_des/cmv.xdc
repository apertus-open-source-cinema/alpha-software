...
# set_input_delay -clock pll_lvds_clk -max  0.5 [get_ports cmv_lvds_data*]
# set_input_delay -clock pll_lvds_clk -max  0.5 [get_ports cmv_lvds_data*] -clock_fall -add_delay
# set_input_delay -clock pll_lvds_clk -min -0.5 [get_ports cmv_lvds_data*]
# set_input_delay -clock pll_lvds_clk -min -0.5 [get_ports cmv_lvds_data*] -clock_fall -add_delay

# set_input_delay -clock pll_lvds_clk -max  0.5 [get_ports cmv_lvds_ctrl*]
# set_input_delay -clock pll_lvds_clk -max  0.5 [get_ports cmv_lvds_ctrl*] -clock_fall -add_delay
# set_input_delay -clock pll_lvds_clk -min -0.5 [get_ports cmv_lvds_ctrl*]
# set_input_delay -clock pll_lvds_clk -min -0.5 [get_ports cmv_lvds_ctrl*] -clock_fall -add_delay
